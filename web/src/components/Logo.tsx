...
export default function Logo({ width = 150 }: { width?: number }) {
  ...
  return (
    <svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1107 288" width={width} height={(288 / 1107) * width} >
        ...
        <circle className="svg-text" style={{ display: "inline", fill: "#2b50eb" }} id="BlueCircle" cx="140.10661" cy="98.857529" r="98.857529" />
        <circle className="svg-text" style={{ display: "inline", fill: "#1ca883" }} id="GreenCircle" cx="98.857529" cy="189.14247" r="98.857529" />
        <path id="CircleIntersection" d="M 98.857422,90.285156 A 98.857529,98.857529 0 0 0 41.945312,108.57227 98.857529,98.857529 0 0 0 140.10742,197.71484 98.857529,98.857529 0 0 0 197.2168,179.2793 98.857529,98.857529 0 0 0 98.857422,90.285156 Z"></path>
    </svg>
  );
}
