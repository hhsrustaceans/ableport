...
export default function LoginForm() {
    ...
    return <form id="registerForm" className="flex flex-col p-2 w-full">
        ...
        <input name="password" required={true} placeholder={t("common.account.password")} type="text" className="action w-full text-left bg-neutral-100 dark:bg-neutral-900 m-1"></input>
    </form>
}