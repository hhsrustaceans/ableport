...
export default function LoginForm() {
    ...
    return <form id="registerForm" className="flex flex-col p-2 w-full">
        <label for="email" className="font-semibold inline-block text-xs text-slate-600 p-1 text-left">{t("common.account.email")}</label>
        ...
        <label for="password" className="font-semibold inline-block text-xs text-slate-600 p-1 text-left">{t("common.account.password")}</label>
